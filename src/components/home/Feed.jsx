...
import { animateCardsIn, animateFeedItem } from "../../utils/gsapAnimations";
...
const Feed = () => {
  ...
  useEffect(() => {
    const cards = feedRef.current?.querySelectorAll('[data-animate="card"]');
    if (cards) {
  ...
  const [insights, setInsights] = useState([
    ...
    },
    {
      ...
      takeaway:
        "We found that indexing tags dbs by 20% increased return by 54%. Database optimization is often overlooked in early stages but becomes critical at scale. By analyzing query execution plans, we identified bottlenecks that were slowing down the entire application.",
      liked: false,
      likes: 18,
      comments: 2,
    },
    {
      ...
      takeaway:
        "Async communication is key for distributed teams. It allows deep work and reduces meeting fatigue. We recommend documentation-first culture.",
      liked: false,
      likes: 125,
      comments: 34,
    },
    {
      ...
      takeaway:
        "Generative UI will change how we build interfaces. Instead of static screens, we will design systems that adapt to user intent in real-time.",
      liked: true,
      likes: 89,
      comments: 12,
    },
  ...
  return (
    <main className="feed-container" ref={feedRef}>
      {/* Create Post Area */}
      <div className="share-insight-card" data-animate="card">
        <div className="share-header">
          ...
          <div className="share-input-wrapper">
            <span className="share-placeholder">
      ...
      <div className="insights-grid">
        {insights.map((insight) => (
          <div key={insight.id} className="insight-card" data-animate="card">
            <div
            ...
            <div className="insight-body">
              ...
              <div className="insight-actions-new">
                <div className="action-main-row">
                  ...
                  >
                    <Icon name={insight.liked ? "thumbs-up" : "thumbs-up"} />{" "}
                    Like
                  </button>
